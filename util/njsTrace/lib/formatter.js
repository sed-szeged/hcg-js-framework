...
Formatter.prototype.inspect = function(arg) {
	// util.inspect break the results to multiple lines if it is too long (see node function reduceToSingleString() in util.js)
	// so here we remove the \n to keep the results as a single line
