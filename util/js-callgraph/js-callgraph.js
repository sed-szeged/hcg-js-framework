...
argParser.addArgument(
    ...
    {
        nargs: 1,
        help: 'Comma separated list of folders to be excluded from analysis'
    }
);
...
let excludeDirs = [];
if (args.excludeDirs) {
    excludeDirs = args.excludeDirs[0].split(",");
}

JCG.setArgs(args);
JCG.setFiles(inputList, excludeDirs);
if (args.filter !== null) {
    let filter = [];
