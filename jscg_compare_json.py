...
dir_tool_map = {
    os.path.join(CONF['cg-path'], 'acg-DEMAND'): 'acg-demand',    
    os.path.join(CONF['cg-path'], 'acg-ONESHOT'): 'acg-oneshot',
    os.path.join(CONF['cg-path'], 'dyn-v8'): 'dyn-v8'
}

out_dir = os.path.join(CONF['cg-path'], 'x-compared')
data_container = {}
